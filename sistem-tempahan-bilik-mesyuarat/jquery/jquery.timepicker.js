...
(function($){
  ...
  $._timePicker = function(elm, settings) {
	...
	//alert(elmOffset.top, elmOffset.left);
    //$tpDiv.appendTo('body').css({'top':elmOffset.top, 'left':elmOffset.left}).hide();	//lsm
    $tpDiv.appendTo('body').hide();		//lsm
